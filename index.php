...
<body>
    <header>
        <!-- Menu de Navegacion con cuatro opciones y en la misma fila(row) el logo-->
        <nav>
            <div class="row">
        ...
        <!--Texto Central de la cabecera con dos botones-->
    ...
    <!-- Seccion en la que aparecen las caracteristicas-->
    <section class="section-features js--section-features" id="features" >
        <!-- Fila (row) con texto y Titulo-->
        <div class="row">
        ...
        <!-- Fila(row) con cuatro columnas con texto e icono-->
    ...
    <section class="section-steps" id="works">
        ...
        <div class="row">
            <div class="col span-1-of-2 steps-box">
                <img class="app-screen js--wp-2" src="resources/img/app-iPhone.png" alt="Ommnifood app on Iphone">
            </div>
            <div class="col span-1-of-2 steps-box">
    ...
    <section class="section-cities" id="cities">
        ...
        <div class="row js--wp-3">
            <div class="col span-1-of-4 box">
                <img class="cities" src="resources/img/lisbon-3.jpg" alt="Lisboa">
                <h3>Lisbon</h3>
            ...
            <div class="col span-1-of-4 box">
                <img class="cities" src="resources/img/san-francisco.jpg" alt="San Francisco">
                <h3>San Francisco</h3>
                <div class="city-feature">
                    <i class="ion-ios-person icon-small"></i>
                    3700+ happy eaters
            ...
            <div class="col span-1-of-4 box">
                <img class="cities" src="resources/img/berlin.jpg" alt="Berlin">
                <h3>Berlin</h3>
                <div class="city-feature">
                    <i class="ion-ios-person icon-small"></i>
                    2300+ happy eaters
            ...
            <div class="col span-1-of-4 box">
                <img class="cities" src="resources/img/london.jpg" alt="London">
                <h3>London</h3>
                <div class="city-feature">
                    <i class="ion-ios-person icon-small"></i>
                    1200+ happy eaters
    ...
    <section class="section-form" id="form">
        ...
        <div class="row">
            <form method="post" action="mailer-new.php" class="contact-form">
                ...
                <div class="row">
                    <div class="col span-1-of-3">
                        <!-- Con el for vinculamos el nombre de la etiqueta
                        label al id de ese nombre y cuando pulsemos la etiqueta
                        el control pasara al input con ese id-->
